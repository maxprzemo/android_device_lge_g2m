 ...
 * {@hide}
 */
public class LgeG2MRIL extends RIL implements CommandsInterface {
    static final String LOG_TAG = "LgeG2MRIL";
    private Message mPendingGetSimStatus;

    private boolean isGSM = false;

    public LgeG2MRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public LgeG2MRIL(Context context, int networkMode, int cdmaSubscription) {
