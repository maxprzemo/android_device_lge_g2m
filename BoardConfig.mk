...
TARGET_OTA_ASSERT_DEVICE := g2m,d620,d620r,D620R,D620
...
TARGET_KERNEL_CONFIG := cm_g2m_defconfig
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=g2m androidboot.selinux=enforcing
